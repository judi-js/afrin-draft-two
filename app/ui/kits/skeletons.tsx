  ...
  return (
    ...
    >
      <div className="flex p-4">
        ...
        <div className="mr-2 h-6 w-16 rounded-md bg-gray-200 text-sm font-medium" />
      </div>
...
export function StudentsChartSkeleton() {
  return (
    <div className={`${shimmer} relative w-full overflow-hidden md:col-span-4`}>
      ...
      <div className="rounded-xl bg-gray-100 p-4">
        ...
        <div className="flex items-center pb-2 pt-6">
          ...
          <div className="mr-2 h-4 w-20 rounded-md bg-gray-200" />
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="flex flex-row items-center justify-between border-b border-gray-100 py-4">
      <div className="flex items-center">
        <div className="ml-2 h-8 w-8 rounded-full bg-gray-200" />
  ...
  return (
    <div className="mb-2 w-full rounded-md bg-white p-4">
      <div className="flex items-center justify-between border-b border-gray-100 pb-8">
        <div className="flex items-center">
          <div className="ml-2 h-8 w-8 rounded-full bg-gray-100"></div>
          <div className="h-6 w-16 rounded bg-gray-100"></div>
        </div>
        <div className="h-6 w-16 rounded bg-gray-100"></div>
      </div>
...
export function StudentTableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-100 last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      ...
      {/* Generate */}
      <td className="whitespace-nowrap py-3 pl-7">
